...
class Line4HAgent(_BaseLine4Specialist):
    """Специалист по паттерну H (line_len_4), с приоритетом H -> I -> J.
    ...
    def choose_draft_pass(self, state: GameState, remaining_cards: Sequence[Card]) -> int:
        ...
        # Равенство: чтобы не плодить рандом в логах, используем стабильный tie-break.
        # Передаем ту, у которой ниже immediate VP на доске соперника.
